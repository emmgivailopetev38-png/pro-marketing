...
import { HOME_FAQ } from "@/lib/seo/home-content";

/* Въпросите живеят в lib/seo/home-content.ts, защото същият текст се
   подава и като FAQPage структурирани данни на началната страница.
   Две копия биха се разминали при първата редакция, а разминаване
   между маркиране и видим текст е нарушение, не дребна грешка. */
const QA = HOME_FAQ;
