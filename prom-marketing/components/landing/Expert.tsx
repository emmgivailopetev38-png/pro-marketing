...
const EXPERTISE = [
  ...
  "CRM системи и lead pipeline дизайн",
  "Meta Ads · Google Ads · performance маркетинг",
  "Изграждане на custom dashboards и операционни системи",
  "Mentoring · научаваш да правиш сам AI системи",
];
          ...
          <div className="md:col-span-7">
            <SectionReveal delay={150}>
              ...
              <p className="mt-5 text-base leading-relaxed text-[var(--color-text-secondary)]">
                Започнах в маркетинга, преминах през performance ads, имейл sequences и CRM-и. Когато AI разби играта през 2023-2024, бях един от първите, които започнаха да правят реални AI агенти за бизнеси — не „chatbot на сайта", а истински системи, които заместват хора в рутината.
              </p>
              <p className="mt-5 text-base leading-relaxed text-[var(--color-text-secondary)]">
                Работя 1-на-1 с всеки клиент. Без overhead, без posredstvo — ти говориш директно с човека, който изгражда системата ти.
              </p>
            </SectionReveal>
