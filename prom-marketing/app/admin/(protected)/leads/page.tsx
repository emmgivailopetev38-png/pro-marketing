...
export default async function LeadsPage() {
  ...
  return (
    <div className="space-y-10 p-6 md:p-10">
      <header className="cc-panel cc-panel-accent overflow-hidden flex flex-wrap items-center justify-between gap-4 p-6">
        <div>
          <p className="hud text-[var(--color-accent-cyan)]">ProMarketing · Лийдове</p>
          <h1 className="cc-title mt-2 font-display text-3xl font-bold">Meta лийдове</h1>
