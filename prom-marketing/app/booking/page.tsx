...
export const metadata: Metadata = {
  ...
  description:
    "Запази 45-минутен разговор с Ивайло Петев — обсъждаме процесите ви и какво AI автоматизация може да направи за бизнеса ви.",
};
  ...
  return (
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#030308] text-[#f5f7ff]">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-20 md:px-12 md:py-28">
        <div className="mb-12 text-center">
          ...
          <h1 className="font-display text-[clamp(36px,7vw,72px)] font-extrabold leading-[0.95]">
            Запази <span className="text-cyan-300">45 мин</span> разговор
          </h1>
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card title="45 минути" body="Достатъчно за дълбок разговор, не за повърхностно представяне." />
      ...
      <ConversionSeoBlock
        path="/booking"
        crumb="Резервация"
        schemaName="Запази 45-минутен разговор за AI автоматизация"
        schemaDescription="Безплатен 45-минутен разговор: минаваме през процесите на бизнеса и излиза списък кои си струва да се автоматизират първи."
        h2="Какво се случва в тези 45 минути"
