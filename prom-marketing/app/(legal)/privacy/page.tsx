...
const updatedAt = "7 септември 2026 г.";
  ...
  return (
    ...
    <article className="prose prose-invert max-w-none">
      ...
      <ul className="text-[var(--color-text-secondary)]">
        ...
        <li>
          Съдържание на разговори с гласовия AI асистент — аудиозапис, транскрипт и резюме (вж.
          раздел 2а);
        </li>
        <li>
      ...
      <h2 className="mt-10 font-display text-2xl font-bold">2а. Разговори с гласовия AI асистент</h2>
      <p className="text-[var(--color-text-secondary)]">
        На сайта и на демонстрационния телефонен номер отговаря AI асистент („Коста“). Той се
        представя като изкуствен интелект в началото на всеки разговор и съобщава, че разговорът се
        записва. Разговорите се записват (аудио и транскрипт) и се обобщават автоматично, за да може
        ProMarketing LTD да подготви консултацията, да отговори на запитването и да подобрява
        асистента. Основанието е преддоговорни отношения (чл. 6, ал. 1, б. „б“ GDPR) и законен
        интерес (б. „е“) за качество и сигурност на услугата.
      </p>
      <ul className="text-[var(--color-text-secondary)]">
        <li>Асистентът не иска и не записва ЕГН, номера на карти, банкови сметки или пароли.</li>
        <li>
          Плащане не се извършва по телефона — при желание за услуга асистентът изпраща линк за
          плащане по имейл, а самото плащане минава през Stripe.
        </li>
        <li>
          Аудиозаписът и транскриптът се съхраняват при доставчика на гласовата платформа до 6
          месеца; резюмето и транскриптът в нашата система — по срока за данни от запитвания.
        </li>
        <li>
          Ако не желаете разговорът да бъде записван, можете да приключите и да си запазите час
          от календара или да ни пишете. Записът може да бъде изтрит по Ваше искане на посочения
          по-долу имейл.
        </li>
      </ul>
      ...
      <ul className="text-[var(--color-text-secondary)]">
        ...
        <li>Аудиозаписи и транскрипти от гласовия асистент при доставчика: до 6 месеца;</li>
      ...
      <ul className="text-[var(--color-text-secondary)]">
        ...
        <li>
          <strong>ElevenLabs Inc.</strong> (САЩ) — гласовият AI асистент: разпознаване и синтез на
          реч, запис и транскрипт на разговорите;
        </li>
        <li>
          <strong>Twilio Inc.</strong> (САЩ) — телефонната линия на демонстрационния номер;
        </li>
        <li>
          <strong>Stripe Payments Europe Ltd.</strong> (Ирландия) — онлайн плащания с карта; ние не
          виждаме и не съхраняваме данни за картата;
        </li>
        <li>
