...
const PROCESS = [
  { step: "1", title: "Разговор", body: "45 минути — обсъждаме процеси, болезнени места и какво искате да отпадне." },
...
const WHY = [
  ...
  { title: "Локален екип", body: "От Пловдив сме. Лична комуникация, лично присъствие при разговор и тренинг — не само автоматизирани чатове." },
];
