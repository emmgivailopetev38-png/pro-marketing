#!/usr/bin/env node
// Финално изпращане към Теодор Лозев.
...
<p><strong>Как работим</strong> — 30 мин разговор за процесите ви, после демо с примерни данни от строителния бранш, после изграждане от 30 до 60 дни според големината на проекта, инсталация на място (1-3 дни), 30 дни безплатна поддръжка.</p>
...
Опитах да ви се обадя — не успях да ви хвана. Затова ви пиша лично.

Аз съм Ивайло Петев от „ПроМаркетинг" ЕООД. Изграждаме AI операционни системи по поръчка.

Подготвих персонална презентация — прикачена като PDF, или онлайн:
https://promarketing.pw/oferta/teodor

Какво ще има в един единен dashboard:
- Обекти live, печалба/разход по проект
- Склад с AI — снимка на фактура → автоматично в склада
- КСС цифрово, генериране на актове
- Счетоводство — export към Microinvest / Бизнес навигатор
- AI Sales — от запитване до подписан договор
- Чат бот на български

Как работим: 30 мин разговор → демо → изграждане 30-60 дни → инсталация 1-3 дни → 30 дни поддръжка.

Резервирайте: https://promarketing.pw/booking
