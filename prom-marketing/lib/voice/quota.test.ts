...
describe("readUsage", () => {
  it("брои секундите само по човек, не по IP", async () => {
    rows.push(
      { seconds: 300, opened_at: new Date().toISOString(), email: "ivo@primer.bg", phone_key: null, ip_hash: "x" },
      // Чужд разговор от същата мрежа — не бива да яде минутите на Иво.
      { seconds: 400, opened_at: new Date().toISOString(), email: "друг@primer.bg", phone_key: null, ip_hash: "x" }
    );
