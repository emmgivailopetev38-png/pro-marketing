...
const MODULES = [
  ...
  { n: "09", title: "Поддръжка · живо", body: "Не ви оставяме сами след стартирането на системата.", bullets: ["30 дни безплатна поддръжка", "Прав хотлайн за спешни въпроси", "Месечна оптимизация и нови функции", "Тренинг видеа за нови служители"] },
];

const PROCESS = [
  { step: "1", title: "Разговор", body: "45 минути — процеси, болезнени места, какво искате да отпадне." },
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          <View style={s.bulletRow}>
            <Text style={s.bullet}>✓</Text>
            <Text style={s.bulletText}>
              <Text style={{ fontWeight: 700 }}>Сами създавате нива.</Text> Добавяте нови stage-ове в CRM-а след стартирането, без програмист.
            </Text>
          </View>
          <View style={s.bulletRow}>
            <Text style={s.bullet}>✓</Text>
