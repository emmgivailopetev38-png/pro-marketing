    ...
    <Document title="Трейдинг Агентът — наръчникът · ProMarketing" author="ProMarketing">
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          <View style={s.warnBox}>
            <Text style={s.warnText}>{TRADING_DISCLAIMER}</Text>
          </View>
        </View>
        <Footer page="1 / 8" />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          {[
            ["„Купувам при пробив”", "» „Купи, когато цената затвори над най-високата стойност от последните 20 свещи, при обем поне 1.5× средния за 20 периода.”"],
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.body}>
          ...
          {[
            ...
            ["Гледайнай-лошия период, не средното", "Максимален спад (drawdown) и най-дълга губеща серия. Ако не можеш да ги изтърпиш психически на демо — няма да ги изтърпиш и с реални пари."],
          ].map(([t, b]) => (
        ...
        <View style={s.body}>
          ...
          <View style={s.warnBox}>
            <Text style={s.warnText}>
              Реалност, без украса: мнозинството хора, които търгуват активно, губят пари —
